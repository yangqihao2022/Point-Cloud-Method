...
#D:\BS\algorithm\Pointnet_Pointnet2_pytorch-master\data\s3dis\stanford_indoor3d
#output_folder = os.path.join(ROOT_DIR, 'data/stanford_indoor3d')
output_folder = 'D:\\BS\\algorithm\\Pointnet_Pointnet2_pytorch-master\\data\\s3dis\\stanford_indoor3d'
